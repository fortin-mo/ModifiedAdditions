...
public class SlimeBucketListener implements Listener
{
    ...
    static {
        SlimeBucketListener.interactables = Arrays.asList(Material.ACACIA_DOOR,
                Material.ACACIA_FENCE_GATE, Material.ANVIL,
                Material.BEACON,
                Material.BED,
                Material.BIRCH_DOOR,
    ...
    public void onBucketSlimeClick(PlayerInteractEntityEvent playerInteractEntityEvent) {
        ...
        if (rightClicked instanceof Slime
                && (inventory.getItemInMainHand().getType().equals((Object)Material.BUCKET)
                || inventory.getItemInOffHand().getType().equals((Object)Material.BUCKET))) {
